    ...
    <div className="grid place-items-center  ">
      <div className="lg:w-1/2 flex flex-col pb-12 w-5/6 md:4/6">
        <div className="md:grid md:grid-cols-3 ">
          ...
          <div className="mt-6 hidden md:block ">
            <div className=" flex relative z-10 text-white text-5xl cursor-pointer">
              <p className="transform rotate-90 absolute top-24 left-24">
                &#x270E;
              </p>
              <p className="absolute top-32 left-24"> &#9473;</p>
            </div>
            <Image
              src="/assests/img.jpg"
              width={385}
          ...
          <>
            ...
            <div className="md:grid md:grid-cols-3 ">
              ...
              <div className="hidden md:block">
                <div className=" bg-red-800 relative z-10 text-white text-5xl cursor-pointer">
                  <p className="absolute top-24 left-24 z-10 text-white text-5xl transform rotate-90  ">
                    &#x270E;
                  </p>
                  <p className="absolute top-32 left-24"> &#9473;</p>
                </div>
        ...
        <input
          ...
          onChange={onChange}
        />
        {fileUrl && <img className="rounded mt-4" width="350" src={fileUrl} alt="fileLoading"/>}
        <button
